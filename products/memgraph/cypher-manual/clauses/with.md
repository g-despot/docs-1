...
1. [Filter on aggregate functions](with.md#1-filter-on-aggregate-functions)
2. [Sorting results](with.md#2-sorting-results)
3. [Limited path searches](with.md#3-limited-path-searches)

## Data Set

The following examples are executed with this data set. You can create this data set locally by executing the queries at the end of the page: [Data Set](with.md#data-set-queries).
