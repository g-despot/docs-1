...
1. [Removing a property](remove.md#1-removing-a-property)
2. [Removing a label](remove.md#2-removing-a-label)

## Data Set

The following examples are executed with this data set. You can create this data set locally by executing the queries at the end of the page: [Data Set](remove.md#data-set-queries).
